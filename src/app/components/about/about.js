            ...
            <div className={styles.content}>
                <div className={styles.text}>
                    ...
                    <p className={styles.info2}>
                        ...
                        <br></br>
                        <br></br>
                        Along the way, I&#39;ve got experience working with both back-end and front-end development. However, I&#39;ve grown a passion for working with the aspects of UI / UX.
                    </p>
                </div>
